  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-4 md:px-8 py-8">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-7xl items-center gap-8">
        ...
        {/* Right: Title & Details */}
        <motion.div
          className="w-full md:w-2/5 flex flex-col justify-center h-full pb-16 md:pb-0"
        ...
        >
          <motion.h1
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            Ashapura Realty – AV Post Production
          </motion.h1>
          ...
          >
            Halfreel Films delivered 1 corporate AV for Ashapura Realty.<br />
            Post-production included offline/online editing, colour grading, sound mixing, 2D animation, and infographics.<br />
            The AV showcased premium properties and lifestyle visuals.<br />
            Animations illustrated project highlights and amenities.<br />
            Colour grading enhanced architectural aesthetics.<br />
            Sound design conveyed warmth and sophistication.<br />
            Pacing balanced information with visual appeal.<br />
            We aligned visuals with the brand’s luxury positioning.<br />
            The AV was tailored for marketing presentations.<br />
            This project reflects our expertise in real estate visual storytelling.<br />
          </motion.p>
        </motion.div>
      </div>
