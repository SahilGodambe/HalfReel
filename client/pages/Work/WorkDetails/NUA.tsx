...
export default function NUA() {
  const [isPlaying, setIsPlaying] = useState(false);
  const sectionRefs = useRef<Array<HTMLDivElement | null>>([]);
  const moreVideos = [
    // Horizontal videos
    "_v2oNCHr2SI?si=abQNeCQmAr6uEZpj",
    "Xs5akqaPJDY?si=21-Rtbaxa_F-mWBN",
  ];
  const videoId = "SRQ9IwNzkT8";
    ...
    <div ref={topRef} className="min-h-screen bg-background text-foreground p-8 overflow-x-hidden">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold text-neon-yellow mb-2">
          NUA – Product Films Post Production
        </h1>
        <p className="text-base md:text-lg text-muted-foreground">
          Halfreel Films created 3 product films.<br />
          Post-production delivered clear, engaging women’s wellness storytelling.
        </p>
      </motion.div>
      ...
      >
        <p className="text-base md:text-lg leading-relaxed text-muted-foreground">
          Halfreel Films delivered 3 product films for NUA.<br />
          Post-production covered offline/online editing, colour grading, sound mixing, and motion graphics.<br />
          Each film explained product features with clarity and warmth.
          Colour grading matched the brand’s clean, modern identity.<br />
          Animations enhanced consumer understanding.
          Audio was mixed for digital-first consumption.<br />
          Pacing balanced product details with viewer engagement.
          Visual consistency built brand recognition.<br />
          The films were optimised for multiple online platforms.
          This project showcases our skill in women’s wellness product content.<br />
        </p>
      </motion.div>
